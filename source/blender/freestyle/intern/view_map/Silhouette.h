...
private:
    ...
    WEdge * _sourceEdge; // for smooth curves, the mesh edge that this svertex lies on, if any
...
public:
    ...
    void setSourceEdge(WEdge * edge) {
        _sourceEdge = edge;
    }

    WEdge *sourceEdge() const
    {
        return _sourceEdge;
    }

    void setSourceVertex(WVertex * v) {
        _sourceVertex = v;
    }

    WVertex *sourceVertex() const
    {
...
public:
    ...
    virtual inline WFace * getFace1() { return NULL; }
    virtual inline WFace * getFace2() { return NULL; }
...
protected:
    ...
    WEdge * _edge; // initial edge of the input mesh
...
public:
    ...
    /*! Returns the WEdge corresponding to the FEdge. */
    inline WEdge * edge() const
    {
        return _edge;
    }

    /*! Returns the face on the left of the FEdge. */
    virtual WFace * getaFace();

    /*! Returns the face on the right of the FEdge. */
    virtual WFace * getbFace();
    ...
    /*! Sets the WEdge corresponding to the FEdge. */
    inline void setEdge(WEdge * edge)
    {
        _edge = edge;
    }
