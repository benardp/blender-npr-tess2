...
public:
    ...
    virtual void processSurfaceIntersectionShape(const vector<WShape*>& shapes);
    virtual void processSurfaceIntersectionFaces(WXFace *iFace1, WXFace *iFace2);
    ...
    inline void enableSurfaceIntersections(bool b)
    {
    ...
    void setUseConsistency(bool uc)
    {
        _useConsistency = uc;
    }
